    ...
    public class DiffControlerTest : IClassFixture<TestFixture<Startup>>
    {
        ...
        public async Task Should_ReturnMessageContentsWithDiffSize_Test()
        {
            ...
            Content content1 = new ContentBuilder()
                ...
                .WithBase64String("BilacSP".CreateDataFromUTF8String())
                .Build();

            Content content2 = new ContentBuilder()
                .WithId(id)
                .WithDirection(ContentDirection.Right)
                .WithBase64String("SalvadorBahiaBrazil".CreateDataFromUTF8String())
                .Build();
        ...
        public async Task Should_ReturnDifferences_Test()
        {
            ...
            Content content2 = new ContentBuilder()
                .WithId(id)
                .WithDirection(ContentDirection.Right)
                .WithBase64String("BilakRP".CreateDataFromUTF8String())
                .Build();
